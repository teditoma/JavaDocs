...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Collections.list(parameterNames).forEach(x->{
            paramsMap.put(x,request.getParameter(x));
            System.out.println(x + " " + request.getParameter(x));
        });

        System.out.println(paramsMap.entrySet().size());
        ...
        try (InputStream reportStream = getClass().getResourceAsStream(jasperPath)) {
            ...
            String filename = passedTemplate + "." +passedFileType;
